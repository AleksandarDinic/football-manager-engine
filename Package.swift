...
let package = Package(
    name: "FootballManagerEngine",
    products: [
        // Products define the executables and libraries produced by a package, and make
        // them visible to other packages.
        .library(
            name: "FootballManagerEngine",
            targets: ["FootballManagerEngine"])
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: []),
        .testTarget(
            name: "FootballManagerEngineTests",
            dependencies: ["FootballManagerEngine"])
    ]
)
